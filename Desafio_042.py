...
Refaça o desafio 035, acrescentando o recurso de mostrar o tipo de triangulo, Equilátero, Isóceles ou Escaleno.
'''
...
if (c> modAB and c < (a+b)) and (b> modAC and b < (a+c)) and (a> modBC and a < (b+c)):
    ...
    if (a == b) and (a ==c):
        print('Todos os lados são iguais, portanto é um triangulo Equilatero')
    elif (a == b) or (a == c):
        print('Dois dos três lados são iguais, portanto é um triangulo Isóceles')
    elif (a != b) and (a != c):
        print('Nenhum lado é igual, portanto é um triangulo Escaleno')
else:
